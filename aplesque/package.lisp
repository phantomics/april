...
(defpackage #:aplesque
  (:export #:varef #:array-promote #:array-match #:array-depth #:section #:array-to-list #:apply-marginal
           ...
           #:invert-matrix #:left-invert-matrix #:interval-index #:turn #:partition-array #:stencil
           #:count-segments #:array-impress #:matrix-print #:disclose-unitary #:apply-scalar
           #:reduce-array #:permute-axes #:get-first-or-disclose #:assign-element-type #:type-in-common
           #:initialize-for-environment #:array-outer-product #:inverse-outer-product
           #:copy-nested-array #:disclose #:xdotimes #:ydotimes #:get-dimensional-factors
           #:is-integer-array #:apl-array-prototype #:make-empty-array)
  (:use #:cl)
