...
(defun vex-exp (idiom meta exp &optional precedent)
  ...
  (if (not exp)
	...
	(if (not precedent)
		...
		;;(print (list :mm (gethash :functions meta) operation precedent right-value))
		(vex-exp idiom meta from-value (cond ((eq :funcall (caar operation))
						      (if right-value
