;;; -*- Mode:Lisp; Syntax:ANSI-Common-Lisp; Coding:utf-8; Package:AprilDemo.Dfns.Power -*-
;;;; demo.lisp

(in-package :april-demo.dfns.power)

(april-load (with (:space power-demo-space))
            (asdf:system-relative-pathname (intern (package-name *package*) "KEYWORD") "power.apl"))

(specify-demo
 "April power operators demo"
 (with :space power-demo-space
