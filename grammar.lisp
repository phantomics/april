        ...
        (if (or (eq :fn (first this-item))
            ...
            (if (not (getf properties :glyph))
                (if (eq :pt (first this-item))
                    (let* ((nspath (format-nspath (if (not current-path) (rest this-item)
                                                      (append current-path (rest this-item)))))
