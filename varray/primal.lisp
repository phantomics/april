...
(defclass vapri-arith-provec (varray-primal)
...
(defmethod etype-of ((vvector vapri-arith-provec))
...
(defmethod prototype-of ((vvector vapri-arith-provec))
  (declare (ignore vvector))
  0)

;; the shape of an IP vector is its number times its repetition
(defmethod shape-of ((vvector vapri-arith-provec))
...
(defmethod get-reduced ((vvector vapri-arith-provec) function)
